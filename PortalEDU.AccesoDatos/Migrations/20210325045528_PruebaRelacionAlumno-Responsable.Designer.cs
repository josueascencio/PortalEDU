...
namespace PortalEDU.AccesoDatos.Migrations
{
    ...
    [Migration("20210325045528_PruebaRelacionAlumno-Responsable")]
    partial class PruebaRelacionAlumnoResponsable
    {
            ...
            modelBuilder.Entity("PortalEDU.Models.Alumno", b =>
                {
                    ...
                    b.HasOne("PortalEDU.Models.Responsable", "Responsa")
                        .WithMany("Alumno")
                        .HasForeignKey("ResponsaId");

                    b.Navigation("CentroEducativo");

                    b.Navigation("Responsa");
                });
